...
exports.default = new _wizard2.default('setCashAccount', function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            ctx.reply('Which is your cash account?', _markup2.default.keyboard(ctx.wizard.state.accounts).oneTime().extra());
